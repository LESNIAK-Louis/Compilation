...
public class Diff extends Binaire {
    public Diff(Expression e1, Expression e2, int n) {
        super(e1, e2, n);
    }
    ...
    public String toMIPS(List<String> registres) {
        ...
        if(registres.size() >= this.e2.getNombreDePlaces()){
            ...
            sb.append("bne $v0, " + save + ", not_equal").append(nb).append("\n");
            sb.append("li $v0, 0\n");
            sb.append("j fin_not_equal").append(nb).append("\n");
            sb.append("not_equal").append(nb).append(": li $v0, 1\n");
            sb.append("fin_not_equal").append(nb).append(": \n");
        }
        else {
            sb.append("sw $v0,($sp)\n");
            ...
            sb.append("add $sp,$sp,4\n");
            sb.append("lw $t8,($sp)\n");
            sb.append("bne $v0, $t8, not_equal").append(nb).append("\n");
            sb.append("li $v0, 0\n");
            sb.append("j fin_not_equal").append(nb).append("\n");
            sb.append("not_equal").append(nb).append(": li $v0, 1\n");
            sb.append("fin_not_equal").append(nb).append(": \n");
